...
<body>
            ...
            <div class="nav-top">
                <nav class="mnu mx-auto">
                    ...
                    <ul class="menu">
                        ...
                        <li class="mt-sm-3"><a href="#news" class="scroll">Deneyim</a></li>
    ...
    <div class="main">
        ...
        <section class="slide-wrapper" id="about">
            <h2 class="w3_head mb-4">EĞİTİM </h2>
        ...
        <section class="services" id="services">
            <div class="container">
                <h3 class="w3_head mb-4 text-left">YETENEK </h3>
        ...
        <div class="news" id="news">
            <h3 class="w3_head mb-4 text-left">DENEYİM</h3>
        ...
        <section class="wedo" id="contact">
            ...
            <div class="cpy-right text-center">
                <p>
                    © 2022 Conjoint. All rights reserved | Design by
